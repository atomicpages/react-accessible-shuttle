...
export function App(props: any) {
    ...
    return (
        <>
            <p>
                Rolling DOM, otherwise known as virtualization, allows us to define a small amount
                of DOM nodes and recycle their instances. Instead of rendering 10K real DOM nodes in
                the browser we can render about 10 per container and reuse the HTMLElement
                instances.
            </p>
